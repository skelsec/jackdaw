...
class JackDawADGroup(Basemodel):
	...
	ad = relationship("JackDawADInfo", back_populates="groups")
	...
	nTSecurityDescriptor = Column(String, index=True)	
	...
	def from_dict(d):
		...
		group.nTSecurityDescriptor = lf(d.get('nTSecurityDescriptor'))
